...
from .models import AnalysisRequestV3, AnalysisResponseV3, KernelCapabilitiesV1, AllocationRequest, AllocationResponse, AllocationCapabilities
...
def verify():
    ...
    for name,model in [("request",AnalysisRequestV3),("response",AnalysisResponseV3),("capabilities",KernelCapabilitiesV1),("allocation.request",AllocationRequest),("allocation.response",AllocationResponse),("allocation.capabilities",AllocationCapabilities)]:
