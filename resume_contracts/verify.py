...
from .models import AnalysisRequestV3, AnalysisResponseV3, KernelCapabilitiesV1
...
def verify():
    ...
    for name,model in [("request",AnalysisRequestV3),("response",AnalysisResponseV3),("capabilities",KernelCapabilitiesV1)]:
