...
from .models import AnalysisRequestV2, AnalysisResponseV2, KernelCapabilitiesV1
...
def verify():
    ...
    for name,model in [("request",AnalysisRequestV2),("response",AnalysisResponseV2),("capabilities",KernelCapabilitiesV1)]:
