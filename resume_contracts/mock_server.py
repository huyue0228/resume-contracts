...
from .models import AnalysisRequestV5, AllocationRequest
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            try:
                ...
                request=(AllocationRequest if is_allocation else AnalysisRequestV5).model_validate_json(self.rfile.read(size))
